...
<div class="row">
    <div class="col-lg-4 col-lg-offset-4">
        ...
        <h1>Add New Store</h1>
        <?php echo form_open('store/submit', array('class' => 'form-horizontal')); ?>
        <div class="form-group">
            <?php
            echo form_label('Depot Location', 'store_location');
            echo form_error('store_location');
            echo form_dropdown('store_location', $location, $store_location, 'id="store_location" class="form-control"');
