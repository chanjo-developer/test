        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                table = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('store/get_fridges_by_id/') . "/" . $id?>",
                        "type": "POST"
                    },
            ...
            function edit_fridge(id) {
                ...
                $.ajax({
                    url: "<?php echo site_url('store/edit_fridge/')?>/" + id,
                    type: "POST",
                    dataType: "JSON",
            ...
            function save(id) {
                var url;
                if (save_method == 'add') {
                    url = "<?php echo site_url('store/add_fridge') . "/" . $id?>";
                    $.ajax({
                        url: url,
                        type: "POST",
                        data: $('#form').serialize(),
                    ...
                    url = "<?php echo site_url('store/update_fridge') . "/"?>"+id;
                    $.ajax({
                        url: url,
                        type: "POST",
            ...
            function delete_fridge(id) {
                if (confirm('Are you sure delete this data?')) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('store/delete_fridge/')?>/" + id,
                        type: "POST",
                        dataType: "JSON",
                        success: function (data) {
