...
<div class="row">
    <div class="col-lg-12">
        <a href="<?php echo site_url('store/create'); ?>" class="btn btn-primary">Add Store</a>
    </div>
</div>
<div class="row">
    </br>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table1 = $('#table1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('store/stores')?>",
                    "type": "POST"
                },
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table2 = $('#table2').DataTable({
                ...
                // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('store/other_stores')?>",
                    "type": "POST"
                },
